pipeline{
    ...
    post{
        always{
         ...
         unsuccessful{
            emailext attachLog: true, body: 'See the attached log bellow', subject: 'Build $BUILD_NUMBER has failed', to: 'cunhagustavo142@gmail.com'
         }

         fixed{
            emailext attachLog: true, body: 'See the attached log bellow', subject: 'Build is Fine!', to: 'cunhagustavo142@gmail.com'
         }
    }
}
