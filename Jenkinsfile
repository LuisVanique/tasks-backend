pipeline{
        ...
        stage('Sonar Analysis'){
            ...
            steps{
                withSonarQubeEnv('SONAR_LOCAL'){
                    bat "${scannerHome}/bin/sonar-scanner -e -Dsonar.projectKey=DeployBack -Dsonar.host.url=http://localhost:9000 -Dsonar.login=sqp_3ec703f1ed4dd35a0aa5e577a4d72459cf8328af -Dsonar.java.binaries=target -Dsonar.coverage.exclusions=**/.mvn/**,**/src/test/**,**/model/**,**/*Application.java,**/RootController.java"
                }
            }   
        }
        stage('Quality Gate'){
    ...
    post{
        always{
         ...
         unsuccessful{
            emailext attachLog: true, body: 'See the attached log bellow', subject: 'Build $BUILD_NUMBER has failed', to: 'cunhagustavo142+jenkins@gmail.com'
         }

         fixed{
            emailext attachLog: true, body: 'See the attached log bellow', subject: 'Build is Fine!', to: 'cunhagustavo142+jenkins@gmail.com'
         }
    }
}
